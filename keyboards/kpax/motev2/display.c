...
void init_styles(void) {
    ...
    lv_style_set_bg_color(&style_button_active, lv_palette_main(LV_PALETTE_BROWN));
...
bool display_init_kb(void) {
    ...
    lv_theme_t *lv_theme   = lv_theme_default_init(lv_display, lv_palette_main(LV_PALETTE_BROWN), lv_palette_main(LV_PALETTE_BLUE), true, LV_FONT_DEFAULT);
